  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4" style={{ background: 'var(--color-background)' }}>
      ...
      <div className="card w-full max-w-sm flex flex-col gap-6 relative z-10">
        ...
        <p className="text-center text-[10px] leading-relaxed" style={{ color: 'var(--color-text-3)' }}>
          <AlertCircle className="h-3 w-3 inline mr-1" />
          Problemas de acesso? Use a conta <strong style={{ color: 'var(--color-accent)' }}>adriano.founder@gmail.com</strong> com a senha padrão.
        </p>
      </div>
    </div>
  );
